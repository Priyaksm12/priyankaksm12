public class employeewage {
        ...
        public static void main(String[] args) {
            ...
            employeewage DayMart = new employeewage("DayMart",20,20,100);
            employeewage YMall = new employeewage("YMall",10,20,100);
            employeewage LuluMall = new employeewage("LuluMall",15,20,100);
